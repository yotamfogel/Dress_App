#!/usr/bin/env python3
"""
🤖 Local AI Backend Server for Clothing Detection
Uses YOLO + SAM for advanced clothing detection and color analysis
"""
...
def health_check():
    ...
    return jsonify({
        ...
        "sam_loaded": clothing_detector is not None,
        "yolo_loaded": clothing_detector is not None and hasattr(clothing_detector, 'yolo_model')
    })
...
def test_endpoint():
    ...
    return jsonify({
        ...
        "models_loaded": {
            "yolo": clothing_detector is not None and hasattr(clothing_detector, 'yolo_model'),
            "sam": clothing_detector is not None and hasattr(clothing_detector, 'sam_model')
        }
    })
